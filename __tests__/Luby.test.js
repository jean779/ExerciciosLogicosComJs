...
test("Questão 02",()=>{
	expect(l.Q2([1,2,3,4])).toEqual([4,3,2,1]);
})
...
test("Questão 03",()=>{
	expect(l.Q3([1,2,'', undefined])).toEqual([1,2]);
})
...
métdodo: {c:2, d:4}*/
test("Questão 04",()=>{
	expect(l.Q4([["c",2],["d",4]])).toEqual({c:2, d:4});
})
...
test("Questão 05",()=>{
	expect(l.Q5([5,4,3,2,5], 5,3)).toEqual([4,2]);
})

/*6) Implemente um método que retorne um array, sem valores duplicados.
Entrada do método ([1,2,3,3,2,4,5,4,7,3]), Resultado do método: [1,2,3,4,5,7]*/
test("Questão 06",()=>{
	expect(l.Q6([1,2,3,3,2,4,5,4,7,3])).toEqual([1,2,3,4,5,7]);
})
...
test("Questão 07",()=>{
	expect(l.Q7([1,2,3,4],[1,2,3,4])).toBe(true);
})
...
[1, 2, 3, 4, 5]*/
test("Questão 08",()=>{
	expect(l.Q8(([1, 2, [3], [4, 5]]))).toEqual([1, 2, 3, 4, 5]);
})

/*9) Implemente um método divida um array por uma quantidade passada por parâmetro.
Entrada do método ([1, 2, 3, 4, 5], 2), Resultado do método: [[1, 2], [3, 4], [5]]*/
test("Questão 09",()=>{
	expect(l.Q9([1, 2, 3, 4, 5], 2)).toEqual([[1, 2], [3, 4], [5]]);
})

/*10) Implemente um método que encontre os valores comuns entre dois arrays.
Entrada do método ([6, 8], [8, 9]), Resultado do método: [8]*/
test("Questão 10",()=>{
	expect(l.Q10([6, 8], [8, 9])).toEqual([8]);
})
